...
async function viewOnceCommand(sock, chatId, message) {
    try {
        ...
        if (isViewOnceImage) {
            try {
                console.log('📸 NIMA MD Processing view once image...');
                ...
                await sock.sendMessage(chatId, { 
                    image: buffer,
                    caption: `*☠️ NIMA MD ViewOnce ☠️*\n\n*Type:* Image 📸\n${caption ? `*Caption:* ${caption}` : ''}`,
                    ...channelInfo
                });
                console.log('✅NIMA MD View once image processed successfully✅');
                return;
            } catch (err) {
        ...
        if (isViewOnceVideo) {
            try {
                console.log('🎥 NIMA MD Processing view once video...');
                ...
                console.log('✅ NIMA MD View once video processed successfully✅');
                return;
            } catch (err) {
